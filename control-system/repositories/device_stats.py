...
class DeviceStatsRepository:
    ...
    def _query(self, time_unit: SQLExtractFields, start_date: datetime, end_date: datetime):
        ...
        return (
            ...
            .group_by(time_unit.value)
            .order_by(time_unit.value)
        )
    ...
    def get_hourly_stats(
        ...
        return self.db.execute(
            self._query(SQLExtractFields.Hour, start_date, end_date)
        ).all()
    ...
    def get_weekday_stats(
        ...
        return self.db.execute(
            self._query(SQLExtractFields.Weekday, start_date, end_date)
        ).all()
    ...
    def get_daily_stats(
        ...
        return self.db.execute(
            self._query(SQLExtractFields.Day, start_date, end_date)
        ).all()
